...
export class LevelMap {
  ...
  obstacleVisible: (Labyrinth, str: string) => boolean;

  constructor(map: string, meta: string, teleportMap: Map<string, string>,
              tile2color: Map<string, string>, texts: {}, background: string,
              textColor: string, targetSpawner: TargetSpawner,
              obstacleVisible: (Labyrinth, str: string) => boolean, obstacleColor: string) {
    this.map = map;
    this.meta = meta;
